...
$('#save,#update').click(function (e) {
   ...
   //Validate Input box or selection box should not be blank or empty
    ...
    // Fecha no valida vencimiento de lote
    for(var n=1;n<rowcount;n++){
     
      var lotes_fecha_v = $("#td_data_"+n+"_fecha_ven").val();
      
      if (lotes_fecha_v.length==0){

        toastr["error"]("Hay una fecha de vencimiento sin asignar");
...
function multi_delete(){
  ...
  //alert(result);return;
...

        {
           ...
           ["error"]("Sorry! Failed to save Record.Try again!");toastr
