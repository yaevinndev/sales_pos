...
class Purchase_return extends MY_Controller {
	...
	public function return_purchase(){
		$rec_fact = $this->input->post('ref_fact');
		//$result= $this->purchase->get_producto_compra($rec_fact);
		echo $this->purchase->purchase_list($rec_fact);
	...
	public function getsupplier(){
		$facture_code = $this->input->post('ref_fact');
		echo $this->purchase->findsupplier($facture_code);
