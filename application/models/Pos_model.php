...
class Pos_model extends CI_Model {
	...
	public function edit_pos($sales_id){
	    ...
	    if($q2->num_rows()>0){
	      ...
	      $other_charges=$res2->other_charges_input;
		  ...
		  if($rows>0){
		  	...
		  	foreach ($q3->result() as $res3) { 
				...
				echo   '<td id="td_'.$i.'_4" class="text-right" >
				<input data-toggle="tooltip" title="Total" id="td_data_'.$i.'_6" name="td_data_'.$i.'_6" type="text" class="form-control no-padding pointer" value="'.number_format($sub_total,2,'.','').'"></td>';    /*num_lote */
