                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                              <label for="ref_purchase" class="col-sm-2 control-label">Nº Fact</label>
                                 
                                 <div class="col-sm-3">

                                       <input type="text"  class="form-control" id="ref_purchase" name="ref_purchase" placeholder="" >

                                       <span id="not_purchase" style="display:none" class="text-danger"></span>
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             ...
                                             <thead class="custom_thead">
                                                ...
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:5%"><?= $this->lang->line('lots'); ?></th>

                                                   <th rowspan='2' style="width:7.5%"><?= $this->lang->line('date_v'); ?></th>
...
<!-- ./wrapper -->
      ...
      <script>
      var ajax_url ="<?php echo site_url('purchase_return/return_purchase')?>";
      var ajax_url2 ="<?php echo site_url('purchase_return/getsupplier')?>";
