                    ...
                    <div class="col-sm-12" style="overflow-y:auto;border:1px solid #337ab7;" >
                      <table class="table table-condensed table-bordered table-striped table-responsive items_table" style="">
                        <thead class="bg-primary">
                          ...
                          <th width="5%"><?= $this->lang->line('quantity'); ?></th>
                          ...
                          <th width="15%"><?= $this->lang->line('lots'); ?></th>
...
function addrow(id){
    ...
    var str=' <tr id="row_'+rowcount+'" data-row="0" data-item-id='+item_id+'>';/*item id*/
        ...
        str+='<td id="td_'+rowcount+'_6" class="text-right"><input data-toggle="tooltip" title="Total" id="td_data_'+rowcount+'_6" name="td_data_'+rowcount+'_6" type="text" class="form-control no-padding pointer"  ></td>';/* td_0_6 item sub_total */
