          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="row">
                    ...
                    <div class="col-md-3">
                        <label for="localization_id" class=" control-label"><?= $this->lang->line('localizacion'); ?></label>
                          <select class="form-control select2" id="localization_id" name="localization_id"  style="width: 100%;">
                            <?php
                               $query1="select * from db_localizations where status=1";
                               $q1=$this->db->query($query1);
                               if($q1->num_rows($q1)>0)
                                {  echo '<option value="">-Seleccione-</option>';
                                    foreach($q1->result() as $res1)
                                  {
                                    echo "<option value='".$res1->id."'>".$res1->localization_name."</option>";
                                  }
                                }
                                else
                                {
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('localizacion'); ?></th>
...
function load_datatable(){
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "columnDefs": [
        {
            "targets": [ 0,1,13 ], //first column / numbering column
...
$("#brand_id,#localization_id,#category_id").change(function(){
