...
<?php
    ...
    $q3=$this->db->query("SELECT a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.purchase_code,b.purchase_note,b.purchase_status,b.purchase_note,
...
<table align="center" width="100%" height='100%'>
    ...
    <thead>
      ...
      <tr>
          ...
          <th colspan="7" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('purchase_invoice'); ?> </b>(<?=$purchase_status;?>)</th>
      ...
      <tr>
          ...
          <th colspan="5" rowspan="1"><?= $this->lang->line('date'); ?> : <?php echo date("Y/m/d"); ?></th>
  ...
  <tr>
    ...
    <th rowspan='2'><?= $this->lang->line('lots'); ?></th>

    <th rowspan='2'><?= $this->lang->line('date_v'); ?></th>
...
<tbody>
 ...
 <?php
              ...
              $q2=$this->db->query("SELECT c.item_name, a.purchase_qty,
                                  ...
                                  a.total_cost,a.num_lote,a.fecha_ven 
              ...
              foreach ($q2->result() as $res2) {
                ...
                //  echo "<td>".$res2->price_per_unit."</td>";
                  ...
                  echo "<td>".$res2->num_lote."</td>";

                  echo "<td>".$res2->fecha_ven."</td>";
...
<tfoot>
  ...
  <tr>
    ...
    <td colspan="11" style="text-align: right;"><b><?= $this->lang->line('subtotal'); ?></b></td>
  ...
  <tr>
    ...
    <td colspan="11" style="text-align: right;"><b><?= $this->lang->line('other_charges'); ?></b></td>
  ...
  <tr>
    ...
    <td colspan="11" style="text-align: right;"><b><?= $this->lang->line('discount_on_all'); ?>(<?= $discount_to_all_input." ".$discount_to_all_type; ?>)</b></td>
  ...
  <tr>
      <td colspan="12">
        <label><b>Nota de Compra</b></label><br>
        </l><?php echo $purchase_note;?>      
      </td>
...
<?php
     ...
     /* function no_to_words($no)
      ...
      {   
        ...
        $words = array('0'=> '' ,'1'=> 'Uno','1.1'=> 'Un'  ,'2'=> 'Dos' ,'3' => 'Tres','4' => 'Cuatro','5' => 'Cinco','6' => 'Seis','7' => 'Siete','8' => 'Ocho','9' => 'Nueve','10' => 'Diez','11' => 'Once','12' => 'Doce','13' => 'Trece','14' => 'Catorce','15' => 'Quince','16' => 'Dieciseis','17' => 'Diecisiete','18' => 'Dieciocho','19' => 'Diecinueve','20' => 'Veinte','30' => 'Treinta','40' => 'Cuarenta','50' => 'Cincuenta','60' => 'Sesenta','70' => 'Setenta','80' => 'Ochenta','90' => 'Noventa',
        '100' => 'Cien','200' => 'Docientos','300' => 'Trecientos','400' => 'Cuatrocientos','500' => 'Quinientos','600' => 'Seicientos','700' => 'Setecientos','800' => 'Ochocientos','900' => 'Novecientos','1000' => 'Mil','100000' => 'Cien Mil','1000000' => 'Millones','1000000.1' => 'Millon');
        ...
        $value1=1000;       
            ...
            while($no>=100)    {
              ...
              if(($value <= $no) &&($no  < $value1) || ($value == 1000000) &&($value1 =''))    {

                if(array_key_exists("$no",$words)){
                  $novalue='';
                }else{
              $novalue=$words["$value"]; //Quinicientos

              $highno = (int)($no/$value); //7500/1000 = 7
                //var_dump($highno);              
              $higno_spanish= $highno*$value; //1800000
               //var_dump($higno_spanish);
               $remainno = $no % $value;
               //var_dump($remainno);
              if(array_key_exists("$higno_spanish",$words)){
                $novalue = '';
                $highno = $higno_spanish;
              }else{
                $higno_spanish=$higno_spanish/1000; //1800
                //var_dump($remainno);
                if($higno_spanish<1000){
                  if(array_key_exists("$higno_spanish",$words)){
                    $novalue = '';
                    $highno = $higno_spanish;
                  }
                }else{//millones
                  $higno_spanish=(int)($higno_spanish/1000);
                 // var_dump($higno_spanish);
                   if($higno_spanish==1){
                    //$value_fix=$value+0.1;
                    $novalue="Millon";
                    $highno=$higno_spanish+0.1;
                    $remainno = $higno_spanish % 1000;
                   }else{
                    $novalue=$words["$value"];
                    $highno=$higno_spanish;
                    $remainno = $higno_spanish % 1000;
              ...
              $value= $value1; //100 - 1000 -10000 - 100000 

              $value1 = $value1 *100; //1000 - 10000 - 100000  - 10000000 
      ...
      //get_instance()->load->helper('letras_helper');

      $formatterES = new NumberFormatter("es-ES", NumberFormatter::SPELLOUT);
      $n=round($grand_total);
      $izquierda = intval(floor($n));
      $derecha = intval(($n - floor($n)) * 100);
      $total_letras= $formatterES->format($izquierda);

      echo "<span class='amt-in-word'>Monto en letras: <i style='font-weight:bold;'>".$total_letras." Netos</i></span>";
