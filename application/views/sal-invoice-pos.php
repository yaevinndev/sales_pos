...
<body onload="window.print();"><!--   -->
    ...
    $resolucion = $this->db->query("SELECT * FROM masterdocumentos");
		    ...
		    if($resolucion->num_rows()>0){
		      ...
		      $text_resolucion="RES. ".$resolucion[0]["resolucion"]." Autoriza desde ".$resolucion[0]["inicio"]." hasta ".$resolucion[0]["final"];
		...
		<tr>
			...
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr>
						<td colspan="6" align="center">
							<?php echo "Farmapos 3.0 NIT 73192.223" ?>
						</td>
					</tr>	

					<tr>
						<td colspan="6" align="center">
							<?php echo "Impreso por Farmapos 3.0 Nit 73192223" ?>
						</td>
					</tr>
