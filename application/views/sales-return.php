                     ...
                     <div class="box box-info " >
                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'sales-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              ...
                              <div class="form-group">
                              <label for="return_assoc" class="col-sm-2 control-label">N° Factura venta</label>        
                                 <div class="col-sm-3">
                                    <div class="input-group">
                                      
                                       <input type="text" class="form-control pull-right"  id="return_assoc"  name="return_assoc">
                                    </div>
                                 </div>        
                              </div>
                           </div>
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="sales_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:7.5%"><?= $this->lang->line('lots'); ?></th>
...
<!-- ./wrapper -->
      ...
      <script>
      var mypath ="<?php echo site_url("sales_return/getsalesitems") ?>";
      var mypath2 ="<?php echo site_url("sales_return/getclient") ?>";
