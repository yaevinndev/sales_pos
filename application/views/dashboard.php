  ...
  <div class="content-wrapper ">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6" >
          <div class="small-box bg-dream-red pulse">
            <div class="inner texte-upercase">
              <h3><?= $total_items_v;?></h3><p>Alertas de vencimiento</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-paper-outline"></i>
            </div>  
            <?php if($CI->session->userdata('inv_userid')==1){ ?>
            <a href="<?= base_url('items/lotsview/1') ?>" class="small-box-footer text-upercase">View <i class="fa fa-arrow-circle-right"></i>  
            </a>
            <?php } ?>
          </div>
        </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
              <table id="example3" class=" datatable table table-bordered table-hover">
                ...
                <tbody>
        <?php
        $qs6="SELECT a.item_name,a.item_code,b.category_name from db_items as a,db_category as b where b.id=a.category_id and a.status=1";
...
<script>
  ...
  /* PIE CHART*/
         ...
         var total_items_v = "<?php echo $total_items_v; ?>";
         if(total_items_v>0){
              pulse_big();
        ...
        function pulse_big(){
          $(".pulse").css("transform","scale(1.1)");
          setTimeout(() => {
            pulse_small();
          }, 1000);
        };

        function pulse_small(){
          $(".pulse").css("transform","scale(1.0)");
          setTimeout(() => {
            pulse_big();
          }, 1000);
        }
