...
<?php
    ...
    $resolucion = $this->db->query("SELECT * FROM masterdocumentos");

    if($resolucion->num_rows()>0){
      $resolucion= $resolucion->result_array();
      $text_resolucion="RES. ".$resolucion[0]["resolucion"]." desde ".$resolucion[0]["inicio"]." hasta ".$resolucion[0]["final"];
...
<?php
...

      {
        ...
        $value1=1000;
            ...
            if(array_key_exists("$highno",$words) && $novalue!='')
  ...
  <tr>
      <td colspan="10" style="text-align: center;">
      Farmapos 3.0 NIT 73192.223<br>
      Impreso por Farmapos 3.0 Nit 73192223
      </td>
  </tr>
