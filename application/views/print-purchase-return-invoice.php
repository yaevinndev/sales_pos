...
<?php
    ...
    $q3=$this->db->query("SELECT b.purchase_id,a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
                           ...
                           b.return_code,b.return_note,b.return_status,b.return_note,
...
<table align="center" width="100%" height='100%'>
    ...
    <thead>
      ...
      <tr>
          ...
          <th colspan="7" rowspan="1"><b style="text-transform: capitalize;"><?= $this->lang->line('purchase_return_invoice'); ?> </b></th>
...
<tfoot>
  ...
  <tr>
      <td colspan="12">
        <label><b>Nota de devolución</b></label><br>
        </l><?php echo $return_note;?>      
      </td>
...
<?php
      ...
      {   
       ...
       $words = array('0'=> '' ,'1'=> 'Uno' ,'2'=> 'Dos' ,'3' => 'Tres','4' => 'Cuatro','5' => 'Cinco','6' => 'Seis','7' => 'Siete','8' => 'Ocho','9' => 'Nueve','10' => 'Diez','11' => 'Once','12' => 'Doce','13' => 'Trece','14' => 'Catorce','15' => 'Quince','16' => 'Dieciseis','17' => 'Diecisiete','18' => 'Dieciocho','19' => 'Diecinueve','20' => 'Veinte','30' => 'Treinta','40' => 'Cuarenta','50' => 'Cincuenta','60' => 'Sesenta','70' => 'Setenta','80' => 'Ochenta','90' => 'Noventa',
        '100' => 'Cien','200' => 'Docientos','300' => 'Trecientos','400' => 'Cuatrocientos','500' => 'Quinientos','600' => 'Seicientos','700' => 'Setecientos','800' => 'Ochocientos','900' => 'Novecientos','1000' => 'Mil','100000' => 'Cien Mil','10000000' => 'Millones');
        if($no == 0)
        ...
        $value1=1000;       
            ...
            while($no>=100)    {
              ...
              $highno = (int)($no/$value); //7500/1000 = 7
               // var_dump($highno);
              $remainno = $no % $value; //7500 % 1000 = 500
              //var_dump($remainno);
                }
